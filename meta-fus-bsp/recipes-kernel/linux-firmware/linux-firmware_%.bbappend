...
do_install:append () {
    ...
    install -m 0644 ${UNPACKDIR}/mxt224.cfg ${D}${nonarch_base_libdir}/firmware/atmel
    install -m 0644 ${UNPACKDIR}/mxt224e_v2.cfg ${D}${nonarch_base_libdir}/firmware/atmel
    install -m 0644 ${UNPACKDIR}/mxt1066.cfg ${D}${nonarch_base_libdir}/firmware/atmel
    install -m 0644 ${UNPACKDIR}/mxt336u-gloves.cfg ${D}${nonarch_base_libdir}/firmware/atmel
    install -m 0644 ${UNPACKDIR}/mxt336u-extra-glass.cfg ${D}${nonarch_base_libdir}/firmware/atmel
    ...
    install -m 0644 ${UNPACKDIR}/wifi_mod_para.conf    ${D}${nonarch_base_libdir}/firmware/nxp
}

PACKAGES =+ " ${PN}-atmel-mxt ${PN}-wifi-fus "
