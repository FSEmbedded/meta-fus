...
# If xwayland is not activated, disable dri support to avoid building errors
# If you need dri support use xwayland.
SRC_URI:append:imx-nxp-bsp = " \
    ${@bb.utils.contains('DISTRO_FEATURES', 'x11', 'file://0002-Disable-dri-for-imx-gpu.patch', 'file://0002-Disable-all-dri-for-imx-gpu.patch', d)} \
"
